...
public static class PostInitializationSource
{
    public const string AutogeneratedHeader = $"""
                                               // ----------------------
                                               // <auto-generated>
                                               // Generated by the {nameof(ImmutableEditableObjectAdapterGenerator)}. DO NOT EDIT!
    ...
    public const string ImmutableEditableValueConverterAttributeShortName = "ImmutableEditableValueConverter";
    ...
    public static void AddSources(IncrementalGeneratorPostInitializationContext context)
    {
        context.AddSource(
            ...
            SourceText.From(string.Join("\n", AutogeneratedHeader, EditableObjectAdapterDeclaration), Encoding.UTF8)
        );
        context.AddSource(
            $"{EditableExtensionsMetadataName}.g.cs",
            SourceText.From(string.Join("\n", AutogeneratedHeader, EditableExtensionsDeclaration), Encoding.UTF8)
        );
    }
}
